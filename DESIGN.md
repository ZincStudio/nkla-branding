...
> Los SVGs están embebidos en base64 para que este archivo .md sea 100% standalone. Un agente de IA que lea este archivo puede ver los logos directamente. Los archivos físicos están en `design/assets/`.
